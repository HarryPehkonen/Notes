...
Deno.test({ name: "Drafts: should save and retrieve a draft", ...opts, fn: async () => {
...
Deno.test({ name: "Drafts: should return null for non-existent draft", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Drafts: should clear a draft", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Drafts: should get all drafts", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Drafts: should update existing draft on re-save", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Drafts: should track server updated_at", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Drafts: should detect draft newer than server", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Drafts: should detect draft not newer than server", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Pending: should queue an operation", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Pending: should retrieve pending operations", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Pending: should get pending for specific note", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Pending: should remove an operation", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Pending: should clear all pending for a note", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Pending: should get pending count", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Pending: should update an operation", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
...
Deno.test({ name: "Cleanup: should clear all data", ...opts, fn: async () => {
  await resetPersistence();
  await persistence.init();
