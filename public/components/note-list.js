                    ...
                    <div class="note-main">
                        <div class="note-title">
                            ${note.is_pinned ? '  ' : ''}${this.searchQuery
                                ? html`<span .innerHTML=${this.highlightText(note.title, this.searchQuery)}></span>`
                                : note.title
                            }
                        </div>
                        <div class="note-content">
                            ${this.searchQuery
                                ? html`<span .innerHTML=${this.highlightText(note.content, this.searchQuery)}></span>`
                                : note.content
                            }
                        </div>
                    </div>
